...
- feat: add remote LangGraph agent connection (health + trigger) — vincenthus
...
- [#398](https://github.com/Tracer-Cloud/opensre/pull/398) feat: add remote LangGraph agent connection (health + trigger) (author: vincenthus; contributors: vincenthus; labels: _none_; files: `Makefile`, `app/cli/__main__.py`, `app/cli/wizard/store.py`, `app/config.py`, `app/graph_pipeline.py`, `app/remote/__init__.py`, `app/remote/client.py`, `app/remote/renderer.py`, `app/remote/server.py`, `app/remote/stream.py`, and 29 more)
