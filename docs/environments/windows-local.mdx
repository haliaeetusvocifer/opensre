---
title: "Windows"
description: "Run OpenSRE on Windows using WSL or GitHub Codespaces"
---

<Info>
**No Native Windows Support**<br/>
OpenSRE is not natively compatible with Microsoft Windows at the moment. We recommend using one of the quick alternatives below.
</Info>
...
Try OpenSRE instantly in a cloud development environment without any local setup.
