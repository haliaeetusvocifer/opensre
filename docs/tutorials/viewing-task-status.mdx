...
description: 'Learn how to monitor and view the status of your tasks in OpenSRE'
---
...
When executed correctly, you should be able to see the following screen in the OpenSRE dashboard:
...
<Tip>OpenSRE updates task status in real-time, so you can monitor progress without refreshing the page.</Tip>

OpenSRE provides detailed visibility into task execution, allowing you to track progress, identify bottlenecks, and ensure your workflows are running smoothly.

## Accessing Task Status

<Steps>
  <Step title="Navigate to Pipelines Overview">
    Open the OpenSRE dashboard and select the **"Pipelines"** tab next to "Overview". This will show you all the pipelines that have been run.
...
OpenSRE displays tasks with the following status indicators:
...
How to get even more out of OpenSRE's capabilities:
