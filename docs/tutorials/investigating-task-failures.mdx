...
description: 'Debug and resolve failures with OpenSRE powerful diagnostic tools'
---

## Overview

OpenSRE automatically captures logs, resource metrics, and system call data for every task, even those that fail. 
Therefore, when tasks fail, OpenSRE provides detailed information to help you understand what went wrong and how to fix it.
...
<Info>
OpenSRE's eBPF monitoring captures resource usage leading up to failures, helping you identify resource constraints.
</Info>
