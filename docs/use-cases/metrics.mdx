---
title: "Metrics"
description: "Track and analyze comprehensive pipeline metrics with OpenSRE"
---

## Overview

OpenSRE automatically captures detailed metrics for every process in your pipeline, providing deep visibility into resource usage, performance, and execution patterns without requiring any code changes.
